...
const initDatabase = () => {
  return new Promise((resolve, reject) => {
    db.serialize(() => {
      ...
      db.run('CREATE INDEX IF NOT EXISTS idx_categories_isActive ON categories(isActive)');
      db.run('CREATE INDEX IF NOT EXISTS idx_categories_name ON categories(name)');
      db.run('CREATE INDEX IF NOT EXISTS idx_expenses_categoryId ON expenses(categoryId)');
      ...
      db.run('CREATE INDEX IF NOT EXISTS idx_expenses_isRecurring ON expenses(isRecurring)');
    });
  });
};
